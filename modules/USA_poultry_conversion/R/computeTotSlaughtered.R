...
computeTotSlaughtered = function(data, FormulaParameters=animalFormulaParameters, flagTable = faoswsFlagTable){
    ...
    data[!is.na(takeOffRate)& 
         ...
         TakeOffFlagObservationStatus:=aggregateObservationFlag(get(animalFormulaParameters$areaHarvestedObservationFlag),
                                                                get(animalFormulaParameters$productionObservationFlag),flagTable = ReadDatatable("ocs2023_flagweight"))]
